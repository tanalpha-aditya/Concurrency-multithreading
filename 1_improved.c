...
void *cus_func(void *arg)
{
    ...
    else
    {
        ...
        // printf("start time : %ld, time taken : %d, time patience : %d, time arrival : %d\n", time(NULL)-startTime, cus->time_taken, cus->time_patience, cus->time_arrival);
